...
import { APP_NAME, CONTACT_INFO, SOCIAL_LINKS } from '@/constants/config';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">
              ...
              Лучшие туры по самым живописным местам страны.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to={ROUTES.TOURS} className="text-gray-400 hover:text-white transition-colors">
                  {t('tours')}
                </Link>
              </li>
              <li>
                <Link to={ROUTES.GALLERY} className="text-gray-400 hover:text-white transition-colors">
                  {t('gallery')}
                </Link>
              </li>
              <li>
