          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <a href={`tel:${CONTACT_INFO.PHONE}`} className="text-primary-600 hover:text-primary-700 font-medium">
                  {CONTACT_INFO.PHONE}
                </a>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <a href={`mailto:${CONTACT_INFO.EMAIL}`} className="text-primary-600 hover:text-primary-700 font-medium">
                  {CONTACT_INFO.EMAIL}
                </a>
              </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Наш офис</p>
                  </div>
                </div>
